...
def receipt(id):
    ...
    pdf.drawCentredString(300, 785, "Generated by School ERP System")

    # ================= LOGO =================
    logo_path = "static/logo.png"
    if os.path.exists(logo_path):
        pdf.drawImage(logo_path, 250, 820, width=80, height=60)
    ...
    pdf.drawCentredString(300, 50, "Thank you for using School ERP")
